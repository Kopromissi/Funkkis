...
getLibDir = catchIO (getEnv "UrlParse_libdir") (\_ -> return libdir)
getDynLibDir = catchIO (getEnv "UrlParse_dynlibdir") (\_ -> return dynlibdir)
getDataDir = catchIO (getEnv "UrlParse_datadir") (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "UrlParse_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "UrlParse_sysconfdir") (\_ -> return sysconfdir)
